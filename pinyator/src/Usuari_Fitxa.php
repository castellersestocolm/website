...
<form method='post' action='Usuari_Desa.php'>
	<div class="form_group">
		...
		<option value=3 <?php if($carrec==3) echo "selected";?>>Músic</option>
		</select>
		<br><br>
		<h3>Seguretats</h3>
		...
		<option value=2 <?php if($segevent==2) echo "selected";?>>Escritura</option>
		</select>
		<br>
		...
		<option value=2 <?php if($segcasteller==2) echo "selected";?>>Escritura</option>
		</select>
		<br>
		...
		<option value=2 <?php if($segcastell==2) echo "selected";?>>Escritura</option>
		</select>
		<br>
		...
		<option value=2 <?php if($segboss==2) echo "selected";?>>Escritura</option>
		</select>
		<br><br>
