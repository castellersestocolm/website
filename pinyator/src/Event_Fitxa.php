...
<br><br>
	...
	<label class="radio-inline"><input type="radio" name="tipus" <?php if($tipus==-1) echo"checked"?> value=-1 <?php BlockMusic()?> >Altres</label>
	<label class="radio-inline"><input type="radio" name="tipus" <?php if($tipus==0) echo"checked"?> value=0 <?php BlockMusic()?> >Assaig</label>
	<label class="radio-inline"><input type="radio" name="tipus" <?php if($tipus==1) echo"checked"?> value=1 <?php BlockMusic()?> >Actuació</label>
	<label class="radio-inline"><input type="radio" name="tipus" <?php if($tipus==-2) echo"checked"?> value=-2>Músics</label>
<br><br>
