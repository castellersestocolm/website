...
<?php $menu=7; include "$_SERVER[DOCUMENT_ROOT]/pinyator/Menu.php";
	...
	if ($id > 0)
	{
		$sql="SELECT NOM, ESNUCLI, ESCORDO, ESTRONC, ESFOLRE, COLORFONS, COLORTEXT, ESCANALLA, COLORCAMISA, ESMUSIC
		FROM POSICIO
		WHERE POSICIO_ID = ".$id;
...
?>
	...
	<div class="form_group">
		...
		<br><br>
		<label>Es music</label>
		<label class="switch">texte
			<input type="checkbox" name="esmusic" value=1 <?php if ($esmusic == 1) echo " checked";?>>
			<span class="slider round"></span>
		</label>
		<br><br>
