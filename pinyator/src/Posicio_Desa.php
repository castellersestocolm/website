...
if(!empty($_POST["esmusic"]))
	$esmusic = intval($_POST["esmusic"]);
else
	$esmusic = 0;
...
if ($id > 0)
{
	...
	",ESTRONC=".$estronc.",ESFOLRE=".$esfolre.",ESCANALLA=".$escanalla.",ESMUSIC=".$esmusic.
	",COLORFONS='".$colorfons."',COLORTEXT='".$colortext."',COLORCAMISA='".$colorcamisa."' 
	 WHERE POSICIO_ID = ".$id;
}
else
{
	$sql="INSERT INTO POSICIO(NOM, ESNUCLI, ESCORDO, ESTRONC, ESFOLRE, ESCANALLA, COLORFONS, COLORTEXT, COLORCAMISA, ESMUSIC) 
	VALUES('".$nom."',".$esnucli.",".$escordo.",".$estronc.",".$esfolre.",".$escanalla.",'".$colorfons."','".$colortext."','".$colorcamisa."',".$esmusic.")";
}
