...
import {
  apiUserFamilyMemberDelete,
  apiUserFamilyMemberUpdate,
  apiUserMe,
} from "../../api";
...
export default function FormMemberUpdate({ member }: any) {
  ...
  function handleDeleteSubmit() {
    apiUserFamilyMemberDelete(member.id).then((response) => {
        ...
        <Grid container spacing={3}>
          ...
          <FormGrid size={{ xs: 12, md: 6 }}>
            ...
            <OutlinedInput
              ...
              required
              size="small"
              defaultValue={member.user.birthday}
              error={
                validationErrors &&
          ...
          <FormGrid size={{ xs: 12, md: 3 }}>
            ...
            <OutlinedInput
              ...
              size="small"
              defaultValue={
                member.user.towers && member.user.towers.height_shoulders
              }
              error={
                validationErrors &&
          ...
          <FormGrid size={{ xs: 12, md: 3 }}>
            ...
            <OutlinedInput
              ...
              size="small"
              defaultValue={
                member.user.towers && member.user.towers.height_arms
              }
              error={
                validationErrors &&
            ...
            <TransitionGroup>
              {submitted && (
                <Collapse>
                  ...
                  >
                    {t("pages.user-family.update.form.success")}
                  </Alert>
                </Collapse>
              )}
              <Collapse>
                <FormGrid size={{ xs: 12 }}>
                  <Stack direction="row" spacing={2} className={styles.buttons}>
                    <Button
                      ...
                      disableElevation
                    >
                      {t("pages.user-family.update.form.button-update")}
                    </Button>
                    <Button
                      variant="contained"
                      type="button"
                    ...
                    >
                      {t("pages.user-family.update.form.button-delete")}
                    </Button>
                  </Stack>
                </FormGrid>
              </Collapse>
