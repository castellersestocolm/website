    ...
    with translation.override(LOCALE_BY_MODULE[program_course_obj.program.module]):
        ...
        for program_course_registration_obj in program_course_obj.registrations.all():
            family_user_objs = (
                ...
                and hasattr(
                    program_course_registration_obj.entity.user, "family_member"
                )
                else []
            )
            ...
            family_names = [
                user_obj.name for user_obj in family_user_objs if user_obj.name
            ]
            ...
            ws.append(
                [
                    ...
                    lastname,
                    age,
                    program_course_registration_obj.family_name,
                    "\n".join(family_names),
                    "\n".join(family_emails),
                    "\n".join(family_phones),
                    str(
