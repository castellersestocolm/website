...
from user.utils import is_over_minimum_age, generate_membership_number
...
class User(AbstractBaseUser, StandardModel, Timestamps, PermissionsMixin):
    ...
    membership_number = models.CharField(unique=True, max_length=12, default=generate_membership_number)
